...
**13 models tested** across 5 model families, 4 quantization levels, and sizes from 0.6B to 30B parameters.

- **13/13** completed full Tier 0 + Tier 1 diagnostics
...
| 13 | Qwen3.5-27B-4bit (NexVeridian) | 27B | 4-bit | WARN | PASS | 1.8 | ✅ |
...
- **Perfect determinism (100%)** across all 13 models. Every model produced identical outputs across 10 runs × 5 prompts at temp=0. This validates the determinism check against both quantized (4-bit, 8-bit) and full-precision (bf16) models.
