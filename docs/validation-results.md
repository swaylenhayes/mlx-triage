...
**32 models tested** across 13 model families, 6 quantization formats, and sizes from 0.6B to 35B parameters.

- **32/32** completed Tier 0 diagnostics successfully
- **13/13** original models completed full Tier 0 + Tier 1 diagnostics
...
### Original Tier 0 + Tier 1 Validated (13 models)
...
| 16 | Qwen3-8B-4bit | 8B | 4-bit | WARN | qwen3 | ✅ |
...
- **Perfect determinism (100%)** across all 13 Tier 1 models. Every model produced identical outputs across 10 runs × 5 prompts at temp=0. This validates the determinism check against both quantized (4-bit, 8-bit) and full-precision (bf16) models.
